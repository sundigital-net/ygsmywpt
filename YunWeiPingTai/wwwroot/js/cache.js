    ...
    function showNotice(){
        layer.open({
            ...
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;">' +
                '<p class="layui-red">运维管理平台1.0版现已测试运行，使用过程中遇到各种问题是在所难免的，希望各位小伙伴积极反馈，我们定会尽最大努力去完善，谢谢大家。</p>' +
                '</div>',
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            ...
                            '<div class="admin-header-lock-name" id="lockUserName">运维平台</div>'+
                            '<div class="input_btn">'+
